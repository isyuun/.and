...
import kr.kymedia.karaoke.billing.Security.VerifiedPurchase;
...
public class BillingService extends Service implements ServiceConnection {
	 ...
	 */
	static LinkedList<BillingRequest> mPendingRequests = new LinkedList<BillingRequest>();
	 ...
	 */
	static HashMap<Long, BillingRequest> mSentRequests =
	...
	class ConfirmNotifications extends BillingRequest {
		...
		public ConfirmNotifications(int startId, String[] notifyIds) {
			super(BillingService.this, startId);
	...
	public void handleCommand(Intent intent, int startId) {
		if (Consts.DEBUG) {
			Log.i(TAG, "handleCommand() intent: " + intent);
		}
		try {
	 ...
	 * the purchase succeeds (or is canceled) the {@link BillingReceiver} receives an intent with the action {@link Consts#ACTION_NOTIFY}.
	 ...
	 * @param itemType
	 *          Either Consts.ITEM_TYPE_INAPP or Consts.ITEM_TYPE_SUBSCRIPTION, indicating
	 *          the type of item type support is being checked for.
	 * @param developerPayload
	 *          a payload that is associated with a given
	 ...
	 *          an identifier for the invocation instance of this service
	 * @param notifyIds
	 *          a list of opaque identifiers associated with purchase
	 *          state changes.
	 ...
	 * encoded as a JSON string, and sends that to the {@link BillingReceiver} in an intent with the action {@link Consts#ACTION_PURCHASE_STATE_CHANGED}.
	 ...
	 * @param responseCode
	 *          a response code from Android Market to indicate the state
	 *          of the request
	 */
