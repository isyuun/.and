 ...
 * extends this class and registers an instance of that derived class with {@link ResponseHandler}. The main application implements the callbacks {@link #onBillingSupported(boolean)} and
...
public abstract class PurchaseObserver {
	...
	/**
	 * This is the callback that is invoked when Android Market responds to the {@link BillingService#checkBillingSupported()} request.
	 * 
	 * @param supported
	 ...
	 * update. The database update is handled in {@link ResponseHandler#purchaseResponse(Context, PurchaseState, String, String, long)}.
	 * 
	 * @param purchaseState
	 ...
	 * @param purchaseTime
	 *          the time the product was purchased, in
	 ...
	 * purchase state changes. All purchase state changes are received in {@link #onPurchaseStateChange(PurchaseState, String, int, long)}.
	 ...
	 * RESULT_USER_CANCELED means that the user didn't iap_msg_buy the item.
	...
	public void startBuyPageActivity(PendingIntent pendingIntent, Intent intent) {
		if (mStartIntentSender != null) {
			// This is on Android 2.0 and beyond. The in-app iap_msg_buy page activity
			...
			// This is on Android version 1.6. The in-app iap_msg_buy page activity must be on its
