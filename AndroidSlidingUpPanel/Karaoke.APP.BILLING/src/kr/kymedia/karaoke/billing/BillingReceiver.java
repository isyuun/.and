 ...
 * It also must not start a background thread because that may be killed as soon as {@link #onReceive(Context, Intent)} returns.
 *
...
public class BillingReceiver extends BroadcastReceiver {
	 ...
	 * the application. This method forwards the messages on to the {@link BillingService}, which handles the communication back to Android Market.
