 ...
 * items and subscriptions. See {@link #queryInventory}, {@link #queryInventoryAsync} and related methods.
 *
...
public class IabHelper {
	 ...
	 * the user interacts with Google Play, and the result will be delivered via the activity's {@link android.app.Activity#onActivityResult} method, at which point you must call
	...
	public void launchPurchaseFlow(Activity act, String sku, String itemType, int requestCode,
			OnIabPurchaseFinishedListener listener, String extraData) {
		if (_IKaraoke.DEBUG || _IKaraoke.DEBUG) Log.e(mDebugTag, "launchPurchaseFlow() " + listener);
	...
	public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
		if (_IKaraoke.DEBUG || _IKaraoke.DEBUG) Log.e(mDebugTag, "handleActivityResult() " + mPurchaseListener);
	...
	void consumeAsyncInternal(final List<Purchase> purchases,
		...
		if (_IKaraoke.DEBUG || _IKaraoke.DEBUG) Log.e(mDebugTag, "consumeAsyncInternal() " + singleListener + "," + multiListener);
