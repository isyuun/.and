...
@echo on
REM ex) adb shell monkey -s 3 --throttle 1000 -v --ignore-timeouts --kill-process-after-error --monitor-native-crashes --pct-trackball 0 --pct-nav 0 --pct-majornav 0 --pct-syskeys 0 --pct-appswitch 0 -p com.google.android.youtube 5000
adb shell monkey -s 1 --throttle 500 -v --ignore-timeouts --kill-process-after-error --monitor-native-crashes --pct-trackball 0 --pct-nav 0 --pct-majornav 0 --pct-syskeys 0 --pct-appswitch 0 -p kr.kymedia.karaoke.kpop.kar 10000
REM adb shell monkey -s 3 --throttle 1500 -v --ignore-timeouts --kill-process-after-error --monitor-native-crashes --pct-trackball 0 --pct-nav 0 --pct-majornav 0 --pct-syskeys 0 --pct-appswitch 0 --pct-anyevent 0 -p kr.kymedia.karaoke.kpop.kar 5000 >> %filename%.txt
REM adb shell dumpsys meminfo kr.kymedia.karaoke.kpop.kar >> %filename%.dmp.txt
