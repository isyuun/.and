...
REM adb %DEVICE_OPTION% shell monkey -s 1 --throttle 500 -v --ignore-timeouts --kill-process-after-error --monitor-native-crashes --pct-trackball 0 --pct-nav 0 --pct-majornav 0 --pct-syskeys 0 --pct-appswitch 0 -p com.kumyoung.gtvkaraoke 10000
adb %DEVICE_OPTION% shell monkey -s 0 --throttle 100 -v --kill-process-after-error --monitor-native-crashes --pct-touch 0 --pct-motion 0 --pct-trackball 0 --pct-nav 50 --pct-majornav 50 --pct-syskeys 0 --pct-appswitch 0 --pct-anyevent 0 -p com.kumyoung.gtvkaraoke 1000000
REM adb %DEVICE_OPTION% shell monkey -s 3 --throttle 500 -v --ignore-timeouts --kill-process-after-error --monitor-native-crashes --pct-trackball 0 --pct-nav 0 --pct-majornav 0 --pct-syskeys 0 --pct-appswitch 0 --pct-anyevent 0 -p com.kumyoung.gtvkaraoke 5000 >> %filename%.txt
REM adb %DEVICE_OPTION% shell dumpsys meminfo com.kumyoung.gtvkaraoke >> %filename%.dmp.txt
