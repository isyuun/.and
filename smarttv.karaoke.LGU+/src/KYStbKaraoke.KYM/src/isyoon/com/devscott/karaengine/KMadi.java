...
public class KMadi
{
	...
	{
		Global.Inst().fp.save_trk = Global.Inst().fp.imidi.clone();
		Global.Inst().fp.old_drum_vol = Global.Inst().fp.cur_drum_vol.clone();
	}

	static void madi_midi_back()
	{
		Global.Inst().fp.imidi = Global.Inst().fp.save_trk.clone();
		Global.Inst().fp.cur_drum_vol = Global.Inst().fp.old_drum_vol.clone();
