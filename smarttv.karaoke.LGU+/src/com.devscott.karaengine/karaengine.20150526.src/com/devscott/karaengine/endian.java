...
class endian
{
    ...
    private static short changeByteOrder(short word0)
    {
        throw new Error("Unresolved compilation problem: \n");
    }

    private static char changeByteOrder(char c)
    {
        throw new Error("Unresolved compilation problem: \n");
    }

    private static int changeByteOrder(int i)
    {
        throw new Error("Unresolved compilation problem: \n");
    }

    private static long changeByteOrder(long l)
    {
        throw new Error("Unresolved compilation problem: \n");
    }
    ...
    static long G4LTBPL(int i)
    {
        throw new Error("Unresolved compilation problem: \n");
    }

    static int G4LTBP(int i)
    {
        throw new Error("Unresolved compilation problem: \n");
    }

    static short G2LTBP(short word0)
    {
        throw new Error("Unresolved compilation problem: \n");
    }

    static short G2BTL(short word0)
    {
        throw new Error("Unresolved compilation problem: \n");
    }

    static long G4BTL(long l)
    {
        throw new Error("Unresolved compilation problem: \n");
    }
}
