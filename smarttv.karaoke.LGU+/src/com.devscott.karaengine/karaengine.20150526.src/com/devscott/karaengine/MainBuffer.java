...
class MainBuffer
{
    ...
    static char get_midi_byte(midi_pos_t midi_pos_t)
    {
        throw new Error("Unresolved compilation problem: \n");
    }

    static char read_midi_byte(midi_pos_t midi_pos_t)
    {
        throw new Error("Unresolved compilation problem: \n");
    }

    static void set_midi_byte(char c, midi_pos_t midi_pos_t)
    {
        throw new Error("Unresolved compilation problem: \n");
    }

    private static MainBuffer _instance;
