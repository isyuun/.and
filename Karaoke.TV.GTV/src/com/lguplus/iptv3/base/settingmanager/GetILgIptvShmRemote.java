	...
	private ServiceConnection srvConn = new ServiceConnection() {
		...
		public void onServiceConnected(ComponentName name, IBinder service) {
			...
			try {
				...
				/*
				 * _LOG.d("service", "pvrReturnString :"+pvsReturnString );
				 * _LOG.d("service", "regionCode :"+regionCode );
				 * _LOG.d("service", "lastPvsEvent :"+ lastPvsEvent );
				 * _LOG.d("service", "configXml :"+configXml );
				 */
