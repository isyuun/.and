 ...
 * @since 2016-08-10
 */
class KPRequest4 extends KPRequest3 {
	...
	public KPRequest4(Context context, Handler handler) {
	...
	protected void send() throws Exception {
		...
		if (ni == null || !ni.isConnected() || !ni.isConnectedOrConnecting()) {
			// display error
			Log.wtf(_toString(), getMethodName() + "[NetworkInfo]" + "[NG]" + message);
