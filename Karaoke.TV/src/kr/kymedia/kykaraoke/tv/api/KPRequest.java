...
class KPRequest extends Thread implements _Const {
	...
	public void setMyMenuUrl() {
		if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + p_op + ",MENU,MENU_MYLIST");
		this.p_op = "KP_1500";
		m_strUrl = setKPBase();
	...
	public void setShopMenuUrl() {
		if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + p_op + ",MENU,MENU_SHOP");
		this.p_op = "KP_1500";
		m_strUrl = setKPBase();
		m_strUrl = m_strUrl + "&p_opcode=KP_1500";
		m_strUrl = m_strUrl + "&p_m1=MENU";
	...
	public void setMainUrl(String op, String m1, String m2) {
		if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + op + ", " + m1 + ", " + m2);
		this.p_op = op;
		m_strUrl = setKPBase();
		m_strUrl = m_strUrl + "&p_opcode=" + op;
		m_strUrl = m_strUrl + "&p_m1=MAIN";
		m_strUrl = m_strUrl + "&p_m2=MENU";
		if (IKaraokeTV.DEBUG) Log.i("HAWAII", m_strUrl);
	}
	...
	public void setSongPlayUrl(String op, String m1, String m2, String id) {
		if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + op + ", " + m1 + ", " + m2 + ", " + id);
		this.p_op = op;
		m_strUrl = setKPBase();
		m_strUrl = m_strUrl + "&p_opcode=" + op;
		m_strUrl = m_strUrl + "&p_m1=" + m1;
	...
	public void setSongPlayedTimeUrl(String op, String m1, String m2, String id, String type) {
		if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + op + ", " + m1 + ", " + m2 + ", " + id + ", " + type);
		this.p_op = op;
		m_strUrl = setKPBase();
		m_strUrl = m_strUrl + "&p_opcode=" + op;
		m_strUrl = m_strUrl + "&p_m1=" + m1;
	...
	public void setListenListUrl(String op, String m1, String m2, int page) {
		if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + op + ", " + m1 + ", " + m2 + ", " + page);
		this.p_op = op;
		m_strUrl = setKPBase();
		m_strUrl = m_strUrl + "&p_opcode=" + op;
		m_strUrl = m_strUrl + "&p_m1=" + m1;
	...
	public void setNumberSearchUrl(String op, String m1, String m2, String num) {
		if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + op + ", " + m1 + ", " + m2 + ", " + num);
		this.p_op = op;
		m_strUrl = setKPBase();
		m_strUrl = m_strUrl + "&p_opcode=" + op;
		m_strUrl = m_strUrl + "&p_m1=" + m1;
	...
	public void setListenSongUrl(String op, String m1, String m2, String record_id, String uid) {
		if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + op + ", " + m1 + ", " + m2 + ", " + uid);
		this.p_op = op;
		m_strUrl = setKPBase();
		m_strUrl = m_strUrl + "&p_opcode=" + op;
		m_strUrl = m_strUrl + "&p_m1=" + m1;
	...
	public void setListenOtherUrl(String op, String id, int page) {
		if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + op + ", " + page);
		this.p_op = op;
		m_strUrl = setKPBase();
		m_strUrl = m_strUrl + "&p_opcode=" + op;
	...
	public void setAuthNumberUrl(String op, String phoneno, String authno) {
		if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + op + ", " + phoneno + ", " + authno);
		this.p_op = op;
		m_strUrl = setKPBase();
		m_strUrl = m_strUrl + "&p_opcode=" + op;
		m_strUrl = m_strUrl + "&p_m1=MAIN";
	...
	public void setCertifyStateUrl(String op) {
		if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + op);
		this.p_op = op;
		m_strUrl = setKPBase();
		m_strUrl = m_strUrl + "&p_opcode=" + op;
		m_strUrl = m_strUrl + "&p_m1=MAIN";
	...
	public void setTicketPurchaseCompleteUrl(String op, String RETURN_DATA) {
		if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + op + ", " + RETURN_DATA);
		this.p_op = op;
		m_strUrl = setKPBase();
		m_strUrl = m_strUrl + "&p_opcode=" + op;
		m_strUrl = m_strUrl + "&p_m1=MENU_SHOP";
	...
	//	if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + op + ", " + result);
	//	this.p_op = op;
	//	m_strUrl = setKPBase();
	//	m_strUrl = m_strUrl + "&p_opcode=" + op;
	//	m_strUrl = m_strUrl + "&p_m1=MENU_SHOP";
	...
	public void setEventApply(String id) {
		this.p_op = "KP_0012";
		if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + p_op + ",MENU_HELP,HELP_EVENT," + id);
		m_strUrl = setKPBase();
	...
	public void setEventHP(String id, String hp) {
		this.p_op = "KP_0013";
		if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + p_op + ",MENU_HELP,HELP_EVENT," + id + ", " + hp);
		m_strUrl = setKPBase();
	...
	public void setCouponRegistUrl(String cpn) {
		this.p_op = "KP_0014";
		if (IKaraokeTV.DEBUG) Log.w(_toString(), getMethodName() + "[OP]" + p_op + ",MENU,MENU_SHOP," + cpn);
		m_strUrl = setKPBase();
	...
	//
	//		// if (IKaraokeTV.DEBUG) _LOG.i(_toString(), "[" + m_strUrl + "]");
	//
	//		/*
	...
	//				// if (json != null) {
	//				// if (IKaraokeTV.DEBUG) _LOG.i("JSON", json.toString(2));
	//				// }
	//			} catch (Exception e) {
	//
	//				e.printStackTrace();
	...
	//
	//	// isyoon
	//	if (IKaraokeTV.DEBUG && jArrList != null) {
