...
class Download2 extends Download implements _Const {
	...
	private _Download.onDownloadListener listener;

	public _Download.onDownloadListener getListener() {
		return listener;
	}

	public void setListener(_Download.onDownloadListener listener) {
