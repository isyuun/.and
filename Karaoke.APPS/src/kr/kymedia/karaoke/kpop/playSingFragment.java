...
class playSingFragment extends playFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		mRootView = (ViewGroup) inflater.inflate(R.layout.fragment_sing, container, false);
	...
	public void KPnnnn() {
		...
		try {
			...
			((TextView) v).setTextAppearance(mContext,
					R.style.TextXLargeWhite);
		} catch (Exception e) {
