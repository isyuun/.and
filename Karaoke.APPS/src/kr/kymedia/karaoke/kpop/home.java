...
public class home extends kr.kymedia.karaoke.kpop._home {
	...
	//
	// if (airsdk != null) {
	// android.util.Log.d("Ads - airsdk - NOTIEXIST", getPackageName() + ":" + __CLASSNAME__ + ":initAds:" + getMethodName() + ":" + getApp().isPassUser());
	...
	// }, true);
	//
	// android.util.Log.d("Ads - airsdk - NOTISTART", getPackageName() + ":" + __CLASSNAME__ + ":initAds:" + getMethodName() + ":" + getApp().isPassUser());
	// airsdk.startNotificationAd(false);
	// //test
