...
/**
 * This class handles disk and memory caching of bitmaps in conjunction with the {@link ImageWorker} class and its subclasses. Use {@link ImageCache#getInstance(android.support.v4.app.FragmentManager, ImageCacheParams)} to get an instance
 * of this
 * class, although usually a cache should be added directly to an {@link ImageWorker} by calling {@link ImageWorker#addImageCache(android.support.v4.app.FragmentManager, ImageCacheParams)}.
 */
public class ImageCache {
	 ...
	 * called directly by other classes, instead use {@link ImageCache#getInstance(android.support.v4.app.FragmentManager, ImageCacheParams)} to fetch an ImageCache
	 * instance.
	 *
	 * @param cacheParams
	...
	public static class ImageCacheParams {
		...
		/**
		 * Create a set of image cache parameters that can be provided to {@link ImageCache#getInstance(android.support.v4.app.FragmentManager, ImageCacheParams)} or
